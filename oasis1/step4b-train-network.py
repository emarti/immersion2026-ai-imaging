...
then global average pooling and a small 2-layer classifier. Binary output (demented=1 vs
healthy=0) trained with BCEWithLogitsLoss + AdamW.
...
``outputs/training_log_4b.csv``. step5 overlays the CSVs from all designs (4a-4d).
